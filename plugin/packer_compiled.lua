...
_G.packer_plugins = {
  ...
  cmp = {
    after = { "cmp-emoji", "cmp-buffer", "cmp_luasnip", "cmp-path", "cmp-nvim-lsp" },
  ...
  dashboard = {
    ...
    loaded = true,
    path = "/home/tknightz/.local/share/nvim/site/pack/packer/start/dashboard",
  ...
  headlines = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/tknightz/.local/share/nvim/site/pack/packer/opt/headlines",
  ...
  hlargs = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/tknightz/.local/share/nvim/site/pack/packer/opt/hlargs",
    url = "https://github.com/m-demare/hlargs.nvim"
  },
  illuminate = {
    config = { "\27LJ\2\n�\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\4\0005\3\3\0=\3\5\2B\0\2\1K\0\1\0\23filetypes_denylist\1\0\0\1\6\0\0\20TelescopePrompt\vprompt\14dashboard\fdirvish\rfugitive\14configure\15illuminate\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  lspconfig = {
    after = { "grammarguard", "lspsaga", "lspinstaller", "nullls" },
    commands = { "LspStart" },
  ...
  nginx = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/tknightz/.local/share/nvim/site/pack/packer/opt/nginx",
  ...
  ["nvim-surround"] = {
    config = { "\27LJ\2\nO\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\1\16move_cursor\1\nsetup\18nvim-surround\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/tknightz/.local/share/nvim/site/pack/packer/opt/nvim-surround",
    url = "https://github.com/kylechui/nvim-surround"
  },
  nvimlocalconf = {
    config = { "\27LJ\2\n:\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\nsetup\17config-local\frequire\0" },
    loaded = true,
    path = "/home/tknightz/.local/share/nvim/site/pack/packer/start/nvimlocalconf",
  ...
  project_nvim = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/tknightz/.local/share/nvim/site/pack/packer/opt/project_nvim",
  ...
  restnvim = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/tknightz/.local/share/nvim/site/pack/packer/opt/restnvim",
  ...
  scope = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/tknightz/.local/share/nvim/site/pack/packer/opt/scope",
  ...
  scrollbar = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/tknightz/.local/share/nvim/site/pack/packer/opt/scrollbar",
    url = "https://github.com/petertriho/nvim-scrollbar"
  },
  signature = {
    config = { "\27LJ\2\n~\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\2B\0\2\1K\0\1\0\17handler_opts\1\0\1\vborder\frounded\1\0\2\17transparency\3\1\tbind\2\nsetup\18lsp_signature\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  stabilize = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/tknightz/.local/share/nvim/site/pack/packer/opt/stabilize",
  ...
  ["telescope-live-grep-args.nvim"] = {
    loaded = true,
    path = "/home/tknightz/.local/share/nvim/site/pack/packer/start/telescope-live-grep-args.nvim",
  ...
  theme = {
    after = { "modes", "treesitter", "bufferline", "lualine", "scope" },
  ...
  treesitter = {
    after = { "treesitter-rainbow", "treesitter-textobjects", "hlargs" },
  ...
  ["treesitter-context"] = {
    commands = { "TSContextEnable", "TSContextToggle" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/tknightz/.local/share/nvim/site/pack/packer/opt/treesitter-context",
...
local module_lazy_loads = {
  ...
  projects = "project_nvim",
  ["telescope._extensions.projects"] = "project_nvim"
}
...
-- Config for: nvimlocalconf
time([[Config for nvimlocalconf]], true)
try_loadstring("\27LJ\2\n:\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\nsetup\17config-local\frequire\0", "config", "nvimlocalconf")
time([[Config for nvimlocalconf]], false)
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file TSContextEnable lua require("packer.load")({'treesitter-context'}, { cmd = "TSContextEnable", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file TSContextToggle lua require("packer.load")({'treesitter-context'}, { cmd = "TSContextToggle", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file ProjectRoot lua require("packer.load")({'project_nvim'}, { cmd = "ProjectRoot", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file RestNvim lua require("packer.load")({'restnvim'}, { cmd = "RestNvim", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
...
vim.cmd [[au FileType conf ++once lua require("packer.load")({'nginx'}, { ft = "conf" }, _G.packer_plugins)]]
vim.cmd [[au FileType css ++once lua require("packer.load")({'emmet'}, { ft = "css" }, _G.packer_plugins)]]
vim.cmd [[au FileType nginx ++once lua require("packer.load")({'nginx'}, { ft = "nginx" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'tagalong', 'emmet', 'jsxpretty'}, { ft = "javascript" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'mdpreview', 'headlines'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType python ++once lua require("packer.load")({'sphinx', 'pyindent'}, { ft = "python" }, _G.packer_plugins)]]
vim.cmd [[au FileType org ++once lua require("packer.load")({'orgbullets', 'orgmode', 'headlines'}, { ft = "org" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'theme'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'indentguide', 'editorconfig'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au WinNew * ++once lua require("packer.load")({'stabilize'}, { event = "WinNew *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'neoscroll', 'cleverf', 'todocomment', 'gitconflict', 'comment', 'gitsigns', 'nvim-surround', 'prettyfold', 'illuminate', 'colorizer', 'matchup', 'scrollbar'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
time([[Sourcing ftdetect script at: /home/tknightz/.local/share/nvim/site/pack/packer/opt/nginx/ftdetect/nginx.vim]], true)
vim.cmd [[source /home/tknightz/.local/share/nvim/site/pack/packer/opt/nginx/ftdetect/nginx.vim]]
time([[Sourcing ftdetect script at: /home/tknightz/.local/share/nvim/site/pack/packer/opt/nginx/ftdetect/nginx.vim]], false)
vim.cmd("augroup END")
