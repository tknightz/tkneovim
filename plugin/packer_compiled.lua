...
_G.packer_plugins = {
  ...
  cmp = {
    after = { "cmp-emoji", "cmp-cmdline", "cmp-path", "cmp-nvim-lsp", "cmp-buffer", "cmp_luasnip" },
  ...
  ["cmp-cmdline"] = {
    after_files = { "/home/tknightz/.local/share/nvim/site/pack/packer/opt/cmp-cmdline/after/plugin/cmp_cmdline.lua" },
    load_after = {
      cmp = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/tknightz/.local/share/nvim/site/pack/packer/opt/cmp-cmdline",
  ...
  lspconfig = {
    after = { "lspsaga", "lspinstaller", "grammarguard" },
    commands = { "LspStart" },
  ...
  theme = {
    after = { "treesitter", "lualine", "bufferline" },
  ...
  trouble = {
    commands = { "Trouble", "TroubleToggle", "TroubleOpen" },
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file TroubleToggle lua require("packer.load")({'trouble'}, { cmd = "TroubleToggle", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file TroubleOpen lua require("packer.load")({'trouble'}, { cmd = "TroubleOpen", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'headlines', 'mdpreview'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType javascriptreact ++once lua require("packer.load")({'tagalong', 'jsxpretty', 'emmet'}, { ft = "javascriptreact" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'matchup', 'cleverf', 'neoscroll', 'wordmotion', 'colorizer', 'comment', 'gitsigns', 'todocomment', 'illuminate', 'indentguide', 'sandwich', 'prettyfold'}, { event = "BufRead *" }, _G.packer_plugins)]]
