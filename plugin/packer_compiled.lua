...
_G.packer_plugins = {
  ...
  cmp = {
    after = { "cmp-nvim-lsp", "cmp-buffer", "cmp-path", "cmp-emoji", "cmp_luasnip" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'colorizer', 'sandwich', 'todocomment', 'gitsigns', 'illuminate', 'indentguide', 'neoscroll', 'wordmotion', 'cleverf', 'comment', 'matchup', 'prettyfold'}, { event = "BufRead *" }, _G.packer_plugins)]]
