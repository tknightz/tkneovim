...
_G.packer_plugins = {
  ...
  ["instant-markdown"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/tknightz/.local/share/nvim/site/pack/packer/opt/instant-markdown",
  ...
  theme = {
    after = { "lualine", "bufferline", "treesitter" },
...
vim.cmd [[noremap <silent> s <cmd>lua require("packer.load")({'lightspeed'}, { keys = "s", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[au FileType typescriptreact ++once lua require("packer.load")({'emmet', 'jsxpretty'}, { ft = "typescriptreact" }, _G.packer_plugins)]]
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'instant-markdown'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'matchup', 'neoscroll', 'cleverf', 'comment', 'todocomment', 'prettyfold', 'sandwich', 'gitsigns', 'illuminate', 'wordmotion', 'indentguide', 'colorizer'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp', 'autopairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
