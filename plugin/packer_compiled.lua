...
_G.packer_plugins = {
  ...
  cmp = {
    after = { "cmp-buffer", "cmp_luasnip", "cmp-nvim-lsp", "cmp-emoji", "cmp-path" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'matchup', 'modes', 'neoscroll', 'wordmotion', 'sandwich', 'gitsigns', 'illuminate', 'cleverf', 'colorizer', 'prettyfold', 'comment', 'todocomment'}, { event = "BufRead *" }, _G.packer_plugins)]]
